...
# BBcontrol: ABC+ D+
bayes_model_func(x=4,0.5,event1=c(1,1,1,0,1),event2=c(0,0,0,1,1)) 


# ISOexperimental: ABC+ A-
bayes_model_func(x=3,0.5,event1=c(1,1,1,1),event2=c(1,0,0,0)) 

# ISOcontrol: ABC+ D-
bayes_model_func(x=4,0.5,event1=c(1,1,1,0,1),event2=c(0,0,0,1,0)) 
