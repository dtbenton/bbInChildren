...
BB.E.control = D$choice[D$object=="E" & D$phase=="Phase 1" & D$trial=="control" & D$condition=="BB"]+
  D$choice[D$object=="E" & D$phase=="Phase 2" & D$trial=="control" & D$condition=="BB"]
...
ISO.E.control = D$choice[D$object=="E" & D$phase=="Phase 1" & D$trial=="control" & D$condition=="ISO"]+
  D$choice[D$object=="E" & D$phase=="Phase 2" & D$trial=="control" & D$condition=="ISO"]
